...
- `ARCHITECTURE.md` §4 — trait-mapped crates and their dependencies.
...
- **`ARCHITECTURE.md`** §4 (DAG of dependencies) — shows which crates depend on which traits in `gradatum-core`.
