...
/// E2E : vault_classify avec note inconnue → 404 Not Found.
///
/// L'implémentation heuristique est synchrone et retourne 404 si la note
/// est absente du vault (la classification requiert la lecture de la note).
#[tokio::test]
...
/// E2E : vault_downgrade synchrone — 404 pour une note inexistante (bearer valide).
///
