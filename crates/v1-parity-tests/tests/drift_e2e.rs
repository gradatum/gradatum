//! v1-parity : Drift end-to-end — 3 tests (D5 / spec §0.4 A3)
//!
...
///
/// Phase 2+ : bloqué par le stub write_note Phase 1 — `upsert_file_checksum`
/// n'est pas appelé dans Vault::write_note, donc `file_checksums` reste vide
/// et scan_phase_a ne trouve aucune entrée à comparer.
#[tokio::test]
...
///
/// Phase 2+ : bloqué par le stub write_note Phase 1 — même raison que ci-dessus.
#[tokio::test]
#[ignore = "Phase 2+ : blocked by Vault::write_note stub (upsert_file_checksum not called)"]
