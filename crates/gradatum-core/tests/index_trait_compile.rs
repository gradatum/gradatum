...
//!
//! ## Refactoring traits granulaires
//!
//! Avant le refactoring : `MockIndex` implémentait `Index` avec 10 méthodes directement.
//! Après le refactoring : `Index` est une façade (supertrait sans méthodes propres).
...
/// Mock minimaliste pour tester le dispatch des 3 traits.
...
impl IndexStore for MockIndex {
    ...
    // ── F-44 Semantic Forget — scope resolution ───────────────────────────────
