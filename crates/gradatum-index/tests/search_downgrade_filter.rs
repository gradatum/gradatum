//! Phase 2.1.2 alpha.9 — Tests régression search filter downgrade.
//!
...
/// Phase 2.1.2 alpha.9 — Test 1 : default (include_downgraded=false) exclut les downgraded.
///
...
/// Phase 2.1.2 alpha.9 — Test 2 : include_downgraded=true retourne toutes les notes.
///
...
/// Phase 2.1.2 alpha.9 — Test 3 : score downgraded < score live (pénalité BM25 × 0.1).
///
...
/// Phase 2.1.2 alpha.9 — Test 4 : 0 résultat si toutes les notes sont downgraded (défaut).
///
