//! Tests de la cascade curator Phase 2.0b.
//!
...
use gradatum_curator::dedup::{assess, cosine, DedupVerdict, DEDUP_THRESHOLD};
use gradatum_curator::novelty::{assess_novelty, shingles, NoveltyVerdict};
use gradatum_curator::routing::heuristic_route;
use gradatum_curator::wikilinks::{extract_wikilinks, resolve, WikilinkResolution};
