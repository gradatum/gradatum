...
describe('JobsPage — filtre jour', () => {
  ...
  it('le filtre jour est initialisé sur le jour du last_job du dashboard', async () => {
    ...
    // En UTC la date est déjà 2026-06-10 (à 14h UTC). Attendre que le dashboard
    // réponde et que le filtre soit initialisé (race condition sur CI lent).
    await waitFor(() => expect(input.value).toMatch(/^2026-06-1[01]$/), { timeout: 3000 }); // tolérance TZ locale
  });
