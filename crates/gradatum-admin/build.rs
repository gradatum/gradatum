...
//! un identifiant traçable dans la sortie de `gradatum-admin --version`
//! → segment `(build_sha <sha>)`.
//!
//! # Robustesse
//!
...
//! Le build ne doit JAMAIS échouer à cause de ce script. En particulier,
//! une compilation depuis une archive `.crate` publiée (crates.io, hors dépôt
//! git) doit réussir : le fallback `"unknown"` couvre ce cas.
//!
