...
> commit conventions, release process) will be available as the project matures.
> For now, the essentials are below.
...
See [CODE_OF_CONDUCT.md](CODE_OF_CONDUCT.md) for the full text. In summary: be
